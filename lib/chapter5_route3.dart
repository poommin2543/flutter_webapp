// lib/chapter5_route3.dart - บทที่ 5 สำหรับเส้นทางที่ 3
...
class Chapter5Route3Page extends StatefulWidget {
  final int chapter;
  ...
  @override
  _Chapter5Route3PageState createState() => _Chapter5Route3PageState();
}

class _Chapter5Route3PageState extends State<Chapter5Route3Page> {
  final TextEditingController _commentController = TextEditingController();
  String _message = '';

  // เนื้อหาสำหรับเส้นทางที่ 3 บทที่ 5 (แตกต่างจากเส้นทางที่ 1 และ 2)
  final List<String> questions = [
    "ในเส้นทางที่ 3 นี้ คุณได้เรียนรู้อะไรสำคัญที่สุดเกี่ยวกับการเป็นผู้นำและผู้สร้างการเปลี่ยนแปลง?",
  ];

  final List<List<String>> options = [
    ["การสร้างทีม", "การสื่อสารข้อมูล", "การสร้างแรงบันดาลใจและเป็นแบบอย่างที่ดี", "การวางแผนกิจกรรม"],
  ];
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 20),
                const Text(
                  "ในเส้นทางที่ 3 นี้ คุณได้เรียนรู้เกี่ยวกับการเป็นผู้นำและการสร้างการเปลี่ยนแปลงเพื่อสังคมปลอดบุหรี่ไฟฟ้า",
                  style: TextStyle(
                    fontSize: 20,
                    fontWeight: FontWeight.bold,
                    color: Colors.indigo,
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: 'คุณเรียนรู้อะไรจากการเดินทางในเส้นทางที่ 3 นี้บ้าง?',
