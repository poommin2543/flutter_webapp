  ...
  Future<void> _fetchUserData() async {
    ...
    try {
      final response = await http.get(
        Uri.parse(
          'https://apiwebmoss.roverautonomous.com/get_score?username=${widget.username}',
      ...
      if (response.statusCode == 200) {
        ...
        setState(() {
          _errorMessage =
              'ไม่สามารถดึงข้อมูลผู้ใช้ได้: ${jsonDecode(response.body)['message']}';
          _isLoading = false;
        });
      }
    } catch (e) {
      ...
      body: SafeArea(
        child: _isLoading
            ...
            : SingleChildScrollView(
                // ใช้ SingleChildScrollView เพื่อให้เลื่อนได้หากเนื้อหายาว
                child: Padding(
