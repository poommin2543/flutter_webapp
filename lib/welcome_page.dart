        ...
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) => GateResultPage(
              ...
              message:
                  'กลับมาที่เส้นทางที่ $currentRouteID บทที่ $currentChapter แล้ว 🎉',
      ...
      body: Center(
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              Image.asset(
                'assets/images/Welcome.png', // เปลี่ยนชื่อไฟล์ตามที่คุณมี
                height: 300,
              ),
              ...
              ElevatedButton.icon(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => CommentsPage(username: username),
                    ),
                  );
                },
                style: ElevatedButton.styleFrom(
              ...
              ElevatedButton.icon(
                ...
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => SurveyPage(username: username),
                    ), // ส่ง username
                  );
                },
                style: ElevatedButton.styleFrom(
